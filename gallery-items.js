...
const a = document.querySelector('.lightbox__image')
...
const fna = (e) => {
    e.preventDefault()
    const photoUrlEl = e.target.dataset.source
    const photoNodeNameEl = e.target.nodeName
...
galleryEl.addEventListener('click', fna)
